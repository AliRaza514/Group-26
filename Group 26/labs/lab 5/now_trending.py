import os
os.environ['HADOOP_HOME'] = "C:\\Program Files\\spark-3.5.5-bin-hadoop3"
...
os.environ['SPARK_DIST_CLASSPATH'] = os.path.join(os.environ['HADOOP_HOME'], 'jars\\*')

# Add this critical override
